...
import conservationEconomics from '@/data/conservation-economics.json'
...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    const cards = JSON.parse(
      localStorage.getItem('deck-conservation-economics') || '[]'
    )
  ...
  useEffect(() => {
    ...
    if (deck && deck.dump() && deck.dump().cards) {
      ...
      localStorage.setItem('deck-conservation-economics', JSON.stringify(cards))
    }
  }, [card])

...
import barrons333 from '@/data/barrons333.json'
...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    const cards = JSON.parse(localStorage.getItem('deck-barrons-333') || '[]')
  ...
  useEffect(() => {
    ...
    if (deck && deck.dump() && deck.dump().cards) {
      ...
      localStorage.setItem('deck-barrons-333', JSON.stringify(cards))
    }
  }, [card])
